...
func solve(dst io.Writer, src io.Reader) {
	var diceA, diceB dice
	fmt.Fscan(src, &diceA.top, &diceA.s, &diceA.e, &diceA.w, &diceA.n, &diceA.bottom)
	fmt.Fscan(src, &diceB.top, &diceB.s, &diceB.e, &diceB.w, &diceB.n, &diceB.bottom)
